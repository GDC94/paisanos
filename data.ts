...
export const ethPriceData: EthPriceInfoResponse = {
  eth: "1.00",
  usd: "1,133.52",
};
...
export const apiKey = {
  message:
    "You registered successfully!,save your api key to be able to access it every time you need it to solve the challenge 😁🤞",
  key: "byy2ExX/rnaFuvDXdPOTOjJEQnzYsSJeKVWvP7viU1k=",
};
